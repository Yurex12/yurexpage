...
export default function CreatePostDialog() {
  ...
  return (
    <div className='p-4 flex flex-col h-full'>
      <h1 className='text-4xl text-gray-800 font-medium'>Create Post</h1>

      {/* Content: text $ images */}
      <div className='overflow-y-auto border border-red-500 flex-1'>
        {/* Text */}
        <textarea
          value={text}
          onChange={handleTextChange}
          placeholder="What's on your mind?"
          className='w-full border-2 h-full outline-none text-base font-normal resize-none bg-transparent text-gray-900 leading-relaxed placeholder:text-gray-500'
        />
        {/* Image Previews */}
        {images.length > 0 && (
          <div
